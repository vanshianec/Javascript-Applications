...
handlers.registerUser = function (ctx) {
    ...
    if (firstName.length < 2) {
        notifications.showError('First name should be at least 2 characters long.');
        return;
    }

    if (lastName.length < 2) {
        notifications.showError('Last name should be at least 2 characters long.');
        return;
    }
    ...
    userService.register(firstName, lastName, username, password).then((res) => {
